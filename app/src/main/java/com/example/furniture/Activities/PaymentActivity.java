...
public class PaymentActivity extends AppCompatActivity {
    ...
    private void setupContent() {
        String SERVER_URL = Config.SERVER_URL + "p=getpendingorders&id_user=" + prefHelper.getUserdata("id");
        ...
        asyncHttpClient.get(SERVER_URL, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                if (ordersList.size() > 0) {
                    OrdersAdapter ordersAdapter = new OrdersAdapter(mContext, ordersList, "payment");
