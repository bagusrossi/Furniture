...
public class ManagePaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_managepayment);
    ...
    private void setupContent() {
        String SERVER_URL = Config.SERVER_URL + "p=getallorders";
        ...
        asyncHttpClient.get(SERVER_URL, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                if (ordersList.size() > 0) {
                    OrdersAdapter ordersAdapter = new OrdersAdapter(mContext, ordersList, "manage");
